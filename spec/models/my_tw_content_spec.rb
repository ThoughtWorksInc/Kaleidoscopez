...
describe MyTWContent do

  it "should inherit from Source" do
    MyTWContent.ancestors.should include(Source)
  end
  ...
  before do
    ...
    @my_tw_comment_content = MyTWContent.new(:comment_tag => "dashboard")
  end
  ...
  it "should authenticate user and fetch content when content is present" do
    ...
    MyTwParser.any_instance.stub(:create_item).and_return(Item.new)
