...
Feed.initialize("HBR", "http://feeds.harvardbusiness.org/harvardbusiness", "http://www.creativeclass.com/_wp/wp-content/uploads/manual/clients/HBR.gif")
...
MyTWGroupContent.create(:name => "myTW: Pune Office", :group_name => "Pune Office", :image_url => "https://my.thoughtworks.com/themes/generated_advanced_skin_global/images/myThoughtworks_logo.png")
